...
Учебный проект курса поскольку технологии требуемые ДЗ не подходят к реализации проекта 
Проект был разделен на 2 в одном останется боевой проект в другом будет для ДЗ
Постараюсь делать качественно, но на предложенных технологиях проект не реализуешь
