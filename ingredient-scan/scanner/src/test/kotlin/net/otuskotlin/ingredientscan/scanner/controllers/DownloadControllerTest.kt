...
class DownloadControllerTest {
    ...
    @Test
    fun `download file returns successful response with correct content type`() {
        // Arrange
    ...
    @Test
    fun `download file returns not found when file does not exist`() {
        // Arrange
    ...
    @Test
    fun `download file with special characters in filename returns successful response`() {
        // Arrange
